  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(6,6,18,1) 54%, rgba(7,17,29,1) 62%, rgba(7,27,39,1) 69%, rgba(8,69,82,0.9416360294117647) 100%)'
        }}
    >
        <div className={`${id==6} && 'flex justify-center h-full`}>
            ...
            <div className={cn(
                titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full first-letter:min-h-40 flex flex-col px-5 p-5 lg-p10'
             )}>
